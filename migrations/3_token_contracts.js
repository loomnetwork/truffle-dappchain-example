...
const MyNewToken = artifacts.require('./MyNewToken.sol')
...
module.exports = function (deployer, network, accounts) {
  ...
  deployer.then(async () => {
    ...
    await deployer.deploy(MyNewToken)
    const myNewTokenInstance = await MyNewToken.deployed()
    ...
    console.log(`MyNewERC721XToken Contract Address: ${myERC721XTokenInstance.address}`)
